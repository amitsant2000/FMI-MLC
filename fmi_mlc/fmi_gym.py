...
class fmi_gym(gym.Env):
    ...
    def __init__(self, parameter={}, pyfmi=None):
        ...
        self.parameter['fmu_observation_names'] = list(set(self.parameter['observation_names'][:-(len(self.parameter['forecast_cols']) * self.int(parameter['x']['agent']['setting']['forecast_hours']))]) \
